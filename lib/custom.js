  ...
  */
    ...
    */
    getUserProfileResponse(respObj){
        ...
        if(respObj)
        {
            profileResp.masterUserId = parseInt(respObj[0].id);
            profileResp.firstname = this.nullChecker(respObj[0].firstname);
            profileResp.lastname = this.nullChecker(respObj[0].lastname);
            profileResp.email = this.nullChecker(respObj[0].email);
            profileResp.username = this.nullChecker(respObj[0].username);
    ...
    */
     ...
     * @param {string} msg
    */
    sendResponse(res,code=200,status=0,response={},msg="Database error"){
      res.send({
